...
bool ModulePlayer1::Start()
{
	...
	COLLIDER_TYPE turn_animColliderType[turn_animnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE close_lpColliderType[close_lpnColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE close_lpColliderType2[close_lpnColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	COLLIDER_TYPE close_lpColliderType3[close_lpnColliders3] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE mpColliderType[mpnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE mpColliderType2[mpnColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE mpColliderType3[mpnColliders3] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	COLLIDER_TYPE mpColliderType4[mpnColliders4] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER},{COLLIDER_PLAYER_HIT} };
	COLLIDER_TYPE mpColliderType5[mpnColliders5] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE close_mpColliderType[close_mpnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE close_mpColliderType2[close_mpnColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	COLLIDER_TYPE close_mpColliderType3[close_mpnColliders3] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE hpColliderType[hpnColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE hpColliderType2[hpnColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE hpColliderType3[hpnColliders3] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	COLLIDER_TYPE hpColliderType4[hpnColliders4] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	COLLIDER_TYPE hpColliderType5[hpnColliders5] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	...
	COLLIDER_TYPE close_hpColliderType[close_hpnColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE close_hpColliderType2[close_hpnColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	COLLIDER_TYPE close_hpColliderType3[close_hpnColliders3] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	COLLIDER_TYPE close_hpColliderType4[close_hpnColliders4] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	...
	COLLIDER_TYPE close_firstframe_lk_mkColliderType[close_firstframe_lk_mknColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE close_lkColliderType[close_lknColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE mkColliderType1[mknColliders1] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE mkColliderType2[mknColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE mkColliderType3[mknColliders3] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	COLLIDER_TYPE mkColliderType4[mknColliders4] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	...
	COLLIDER_TYPE close_mkColliderType[close_mknColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE hkColliderType[hknColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE hkColliderType2[hknColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE close_hkColliderType[close_hknColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE close_hkColliderType2[close_hknColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE neutraljumpColliderType2[neutraljumpnColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE jlpColliderType2[jlpnColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE jlkColliderType2[jlknColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE jmpColliderType[jmpnColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE jmpColliderType2[jmpnColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE jmkColliderType[jmknColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE jmkColliderType2[jmknColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE jhpColliderType[jhpnColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE jhpColliderType2[jhpnColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE jhkColliderType[jhknColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE jhkColliderType2[jhknColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{COLLIDER_PLAYER},{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE yoga_fire_lpColliderType[yoga_fire_lpnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE yoga_fire_mpColliderType[yoga_fire_mpnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE yoga_fire_hpColliderType[yoga_fire_hpnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE yoga_drillColliderType[yoga_drillnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE yoga_drillColliderType3[yoga_drillnColliders3] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE yoga_mummyColliderType[yoga_mummynColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE yoga_mummyColliderType3[yoga_mummynColliders3] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE cturn_animColliderType[cturn_animnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE close_clpColliderType[close_clpnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE close_clpColliderType2[close_clpnColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE cmpColliderType[cmpnColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE cmpColliderType2[cmpnColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE close_cmpColliderType[close_cmpnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE close_cmpColliderType2[close_cmpnColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE chpColliderType[chpnColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE chpColliderType2[chpnColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE close_clkColliderType[close_clknColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE close_clkColliderType2[close_clknColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE cmkColliderType[cmknColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE cmkColliderType2[cmknColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE close_cmkColliderType[close_cmknColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE close_cmkColliderType2[close_cmknColliders2] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_HIT} };
	...
	COLLIDER_TYPE chkColliderType[chknColliders] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER } };
	COLLIDER_TYPE chkColliderType2[chknColliders2] = { { COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER },{ COLLIDER_PLAYER_HIT } };
	...
	COLLIDER_TYPE win2ColliderType[win2nColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE airreelColliderType[airreelnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE sweepColliderType[sweepnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	COLLIDER_TYPE sweepColliderType2[sweepnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE defendingColliderType[defendingnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE cdefendingColliderType[cdefendingnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
	...
	COLLIDER_TYPE grabbingColliderType[grabbingnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER_GRAB} };
	...
	COLLIDER_TYPE stunColliderType[stunnColliders] = { {COLLIDER_PLAYER}, {COLLIDER_PLAYER}, {COLLIDER_PLAYER} };
...
update_status ModulePlayer1::PreUpdate() {
	ClearColliders();
	IsClose();
...
update_status ModulePlayer1::Update()
{
	...
	if (state == L_YFLAME || state == M_YFLAME || state == F_YFLAME || state == L_YFIRE || state == M_YFIRE || state == F_YFIRE) {
	...
	if (state != current_state)
	{
		...
		case ST_CROUCH_DEFENDING_READY:
			current_animation = &crouch;
			break;
		...
		case L_YFIRE:
			...
			{
				App->particles->AddParticle(App->particles->hdk, flip, position.x + hdk_spawn, position.y - 70, 3, 0, 0, COLLIDER_PLAYER_SHOT, 0, 200);
			}
			typeofattack = 1;
			dizzydamage = 4;
			break;
		...
		case L_PUNCH_CROUCHCLOSE:
			current_animation = &close_clp;
			typeofattack = 1;
			dizzydamage = 1;
			break;

		case M_PUNCH_CROUCHCLOSE:
			current_animation = &close_cmp;
			typeofattack = 2;
			dizzydamage = 2;
			break;

		case L_KIK_CROUCHCLOSE:
			current_animation = &close_clk;
			typeofattack = 1;
			dizzydamage = 1;
			break;

		case M_KIK_CROUCHCLOSE:
...
void ModulePlayer1::ClearColliders() {
...
void ModulePlayer1::OnCollision(Collider* c1, Collider* c2) {
	...
	if (c1->type == COLLIDER_PLAYER && c2->type == COLLIDER_PLAYER2_SHOT) {
		...
		if (App->player2->typeofattack == 2) { pushbacktimerprojectile = 15; pushbackspeed = 2; }
	...
	if (c1->type == COLLIDER_PLAYER_GRAB && c2->type == COLLIDER_PLAYER2)
	{
		...
		if (state == M_GRABBING)
		{
			App->player2->inputs.Push(IN_M_GRABBED2);
		}
	...
	if (invulnerabilityFrames < App->frames) {
		...
		if (c1->type == COLLIDER_PLAYER && c2->type == COLLIDER_PLAYER2_HIT) {
			if (App->player1->state != ST_CROUCH_DEFENDING_READY) {
				if ((flip == false && App->player1->state != ST_WALK_FORWARD) || (flip == true && App->player1->state != ST_WALK_BACKWARD)) {
					if (App->frames - App->player2->l_close_standing_punch_timer == 2 || App->frames - App->player2->l_close_standing_kik_timer == 4 || App->frames - App->player2->l_standing_kik_timer == 6 || App->frames - App->player2->m_standing_kik_timer == 6 || App->frames - App->player2->m_close_standing_kik_timer == 4 || App->frames - App->player2->f_standing_kik_timer == 13 || App->player2->state == L_PUNCH_BACKWARD_JUMP2 || App->player2->state == L_PUNCH_FORWARD_JUMP2 || App->player2->state == L_PUNCH_NEUTRAL_JUMP2 || App->player2->state == M_PUNCH_BACKWARD_JUMP2 || App->player2->state == M_PUNCH_FORWARD_JUMP2 || App->player2->state == M_PUNCH_NEUTRAL_JUMP2
						|| App->player2->state == F_PUNCH_BACKWARD_JUMP2 || App->player2->state == F_PUNCH_FORWARD_JUMP2 || App->player2->state == F_PUNCH_NEUTRAL_JUMP2 || App->player2->state == L_KIK_BACKWARD_JUMP2 || App->player2->state == L_KIK_FORWARD_JUMP2 || App->player2->state == L_KIK_NEUTRAL_JUMP2 || App->player2->state == M_KIK_BACKWARD_JUMP2 || App->player2->state == M_KIK_FORWARD_JUMP2 || App->player2->state == M_KIK_NEUTRAL_JUMP2
						|| App->player2->state == F_KIK_BACKWARD_JUMP2 || App->player2->state == F_KIK_FORWARD_JUMP2 || App->player2->state == F_KIK_NEUTRAL_JUMP2) {
						if (flip == true) { App->particles->AddParticle(App->particles->lhead2, !flip, App->player1->position.x - 20, App->player2->position.y - 90, 0, 0, 0, COLLIDER_WALL, 0, 0); }
						else { App->particles->AddParticle(App->particles->lhead2, !flip, App->player1->position.x + 20, App->player2->position.y - 90, 0, 0, 0, COLLIDER_WALL, 0, 0); }
						if (App->player2->f_standing_kik_timer > 0) {
							if (flip == true) { App->particles->AddParticle(App->particles->blood, !flip, App->player1->position.x + 20, App->player1->position.y - 100, 0, 0, 0, COLLIDER_WALL, 0, 0); }
					...
					if (App->frames - App->player2->l_close_crouching_kik_timer == 4 || App->frames - App->player2->m_close_crouching_kik_timer == 1 || App->frames - App->player2->l_close_crouching_punch_timer == 2 || App->frames - App->player2->m_close_crouching_punch_timer == 3 || App->frames - App->player2->m_crouching_punch_timer == 10 || App->frames - App->player2->l_crouching_punch_timer == 10 || App->frames - App->player2->f_crouching_punch_timer == 13) {
						if (flip == true) { App->particles->AddParticle(App->particles->lhead2, !flip, App->player1->position.x + 20, App->player2->position.y - 20, 0, 0, 0, COLLIDER_WALL, 0, 0); }
						else { App->particles->AddParticle(App->particles->lhead2, !flip, App->player1->position.x - 20, App->player2->position.y - 20, 0, 0, 0, COLLIDER_WALL, 0, 0); }
					}

					if (App->frames - App->player2->l_standing_punch_timer == 6 || App->frames - App->player2->m_standing_punch_timer == 8 || App->frames - App->player2->f_standing_punch_timer == 13 || App->frames - App->player2->m_close_standing_punch_timer == 2 || App->frames - App->player2->f_close_standing_kik_timer == 10) {
						if (flip == true) { App->particles->AddParticle(App->particles->lhead2, !flip, App->player1->position.x + 20, App->player2->position.y - 50, 0, 0, 0, COLLIDER_WALL, 0, 0); }
						else { App->particles->AddParticle(App->particles->lhead2, !flip, App->player1->position.x - 20, App->player2->position.y - 50, 0, 0, 0, COLLIDER_WALL, 0, 0); }
					}

					if (App->player2->state == L_KIK_CROUCH2 || App->player2->state == M_KIK_CROUCH2 || App->player2->state == F_KIK_CROUCH2) {
					...
					if (App->frames - App->player2->f_close_standing_punch_timer == 6) {
						if (flip == true) { App->particles->AddParticle(App->particles->fhead2, !flip, App->player1->position.x + 40, App->player2->position.y - 90, 0, 0, 0, COLLIDER_WALL, 0, 0); }
						else { App->particles->AddParticle(App->particles->fhead2, !flip, App->player1->position.x - 40, App->player2->position.y - 90, 0, 0, 0, COLLIDER_WALL, 0, 0); }
					}
			...
			if ((App->player1->state == ST_CROUCH_DEFENDING_READY) || (flip == false && App->player1->state == ST_WALK_FORWARD) || (flip == true && App->player1->state == ST_WALK_BACKWARD)) {
				if (flip == true) { App->particles->AddParticle(App->particles->defending, !flip, App->player1->position.x + 20, App->player1->position.y - 50, 0, 0, 0, COLLIDER_WALL, 0, 0); }
				else { App->particles->AddParticle(App->particles->defending, !flip, App->player1->position.x - 20, App->player1->position.y - 50, 0, 0, 0, COLLIDER_WALL, 0, 0); }
			}
		}
			...
			state != L_PUNCH_NEUTRAL_JUMP && state != L_PUNCH_FORWARD_JUMP && state != L_PUNCH_BACKWARD_JUMP && state != L_KIK_NEUTRAL_JUMP && state != L_KIK_FORWARD_JUMP && state != L_KIK_BACKWARD_JUMP))
		{
			...
			else if (state == ST_CROUCHING || state == ST_CROUCH || state == ST_STANDING || state == L_PUNCH_CROUCH || state == L_KIK_CROUCH || state == L_KIK_CROUCHCLOSE || state == L_PUNCH_CROUCHCLOSE || state == M_KIK_CROUCH || state == M_KIK_CROUCHCLOSE || state == M_PUNCH_CROUCH || state == M_PUNCH_CROUCHCLOSE || state == F_PUNCH_CROUCH || state == F_KIK_CROUCH)
			{
				...
				if (App->player2->l_standing_punch_timer != 0) { life -= 6; App->player2->puntuation += 100; }
				else if (App->player2->m_standing_punch_timer != 0) { life -= 10; App->player2->puntuation += 200; }
				else if (App->player2->f_standing_punch_timer != 0) { life -= 16; App->player2->puntuation += 300; }
				else if (App->player2->l_standing_kik_timer != 0) { life -= 8; App->player2->puntuation += 100; }
				else if (App->player2->m_standing_kik_timer != 0) { life -= 10; App->player2->puntuation += 200; }
				else if (App->player2->f_standing_kik_timer != 0) { life -= 14; App->player2->puntuation += 300; }
				else if (App->player2->l_close_standing_punch_timer != 0) { life -= 6; App->player2->puntuation += 100; }
				else if (App->player2->m_close_standing_punch_timer != 0) { life -= 10; App->player2->puntuation += 200; }
				else if (App->player2->f_close_standing_punch_timer != 0) { life -= 32; App->player2->puntuation += 300; }
				else if (App->player2->l_close_standing_kik_timer != 0) { life -= 6; App->player2->puntuation += 100; }
				else if (App->player2->m_close_standing_kik_timer != 0) { life -= 10; App->player2->puntuation += 200; }
				else if (App->player2->f_close_standing_kik_timer != 0) { life -= 16; App->player2->puntuation += 300; }
				else if (App->player2->l_crouching_punch_timer != 0) { life -= 6; App->player2->puntuation += 100; }
				else if (App->player2->m_crouching_punch_timer != 0) { life -= 10; App->player2->puntuation += 200; }
				else if (App->player2->f_crouching_punch_timer != 0) { life -= 14; App->player2->puntuation += 300; }
				else if (App->player2->l_crouching_kik_timer != 0) { life -= 8; App->player2->puntuation += 100; }
				else if (App->player2->m_crouching_kik_timer != 0) { life -= 12; App->player2->puntuation += 200; }
				else if (App->player2->f_crouching_kik_timer != 0) { life -= 16; App->player2->puntuation += 300; }
				else if (App->player2->l_close_crouching_punch_timer != 0) { life -= 8; App->player2->puntuation += 100; }
				else if (App->player2->m_close_crouching_punch_timer != 0) { life -= 12; App->player2->puntuation += 200; }
				else if (App->player2->l_close_crouching_kik_timer != 0) { life -= 8; App->player2->puntuation += 100; }
				else if (App->player2->m_close_crouching_kik_timer != 0) { life -= 12; App->player2->puntuation += 200; }
				else if (App->player2->l_d_jumping_punch_timer != 0) { life -= 8; App->player2->puntuation += 100; }
				else if (App->player2->m_d_jumping_punch_timer != 0) { life -= 12; App->player2->puntuation += 200; }
				else if (App->player2->f_d_jumping_punch_timer != 0) { life -= 16; App->player2->puntuation += 300; }
				else if (App->player2->l_d_jumping_kik_timer != 0) { life -= 8; App->player2->puntuation += 100; }
				else if (App->player2->m_d_jumping_kik_timer != 0) { life -= 12; App->player2->puntuation += 200; }
				else if (App->player2->f_d_jumping_kik_timer != 0) { life -= 16; App->player2->puntuation += 300; }
				else if (App->player2->state == YDRILL2) { life -= 12; App->player2->puntuation += 500; }
				else if (App->player2->state == YMUMMY2) { life -= 12; App->player2->puntuation += 500; }
			}
			else {
			...
			if (App->player2->state == F_KIK_CROUCH2) {
		...
		if (c1->type == COLLIDER_PLAYER && c2->type == COLLIDER_PLAYER2) //Colliding players
		{
			if (state == ST_WALK_FORWARD && App->player2->state == ST_WALK_FORWARD2) {
				...
				else if (state == ST_IDLE && App->player2->state == ST_IDLE2) {
					if (IsntOnLeftLimit() && !flip)
						position.x--;
					else if (App->player2->IsntOnLeftLimit() && !flip)
						App->player2->position.x++;
					else if (IsntOnRightLimit() && flip)
						position.x++;
					else if (IsntOnRightLimit() && !flip)
						App->player2->position.x++;
					else if (App->player2->IsntOnRightLimit() && flip)
						App->player2->position.x--;
				}
			}
		}
...
void ModulePlayer1::BlitCharacterAndAddColliders(Animation* current_animation, SDL_Texture* texture) {
...
bool ModulePlayer1::external_input(p2Qeue<ryu_inputs>& inputs)
{
	bool crouch = false;
...
void ModulePlayer1::internal_input(p2Qeue<ryu_inputs>& inputs)
{
	if (jump_timer > 0)
	{
	...
	if (grabbing_timer > 0)
	{
		...
		{
			inputs.Push(IN_GRABBING_FINISH);
			grabbing_timer = 0;
	...
	if (defending_timer > 0)
	{
		...
		{
			inputs.Push(IN_DEFENDING_FINISH);
...
ryu_states ModulePlayer1::process_fsm(p2Qeue<ryu_inputs>& inputs)
{
	...
	while (inputs.Pop(last_input))
	{
		...
		case ST_IDLE:
		{
			...
			case IN_TURNING: state = TURNING; turning_timer = App->frames;  break;

			case IN_JUMP: state = ST_JUMP_NEUTRAL; jump_timer = App->frames;  break;
			case IN_LEFT_AND_JUMP: state = ST_JUMP_BACKWARD; jump_timer = App->frames; break;
			case IN_RIGHT_AND_JUMP: state = ST_JUMP_FORWARD; jump_timer = App->frames; break;
			case IN_BURNING: state = BURNING; break;

			case IN_CROUCH_DOWN: state = ST_CROUCHING; crouching_timer = App->frames; break;
			case IN_LEFT_AND_CROUCH: state = ST_CROUCHING; crouching_timer = App->frames; break;
			case IN_RIGHT_AND_CROUCH: state = ST_CROUCHING; crouching_timer = App->frames; break;

			case IN_L_PUNCH: {
				if (!close) { state = L_PUNCH_STANDING; l_standing_punch_timer = App->frames; }
				else if (close) { state = L_PUNCH_CLOSE; l_close_standing_punch_timer = App->frames; }
			} break;

			case IN_L_KIK: {
				if (!close) { state = L_KIK_STANDING; l_standing_kik_timer = App->frames; }
				else if (close) { state = L_KIK_CLOSE; l_close_standing_kik_timer = App->frames; }
			}break;

			case IN_M_PUNCH: {
				if (!close) { state = M_PUNCH_STANDING; m_standing_punch_timer = App->frames; }
				else if (close) { state = M_PUNCH_CLOSE; m_close_standing_punch_timer = App->frames; }
			}break;

			case IN_M_KIK: {
				if (!close) { state = M_KIK_STANDING; m_standing_kik_timer = App->frames; }
				else if (close) { state = M_KIK_CLOSE; m_close_standing_kik_timer = App->frames; }
			}break;

			case IN_F_PUNCH: {
				if (!close) { state = F_PUNCH_STANDING; f_standing_punch_timer = App->frames; }
				else if (close) { state = F_PUNCH_CLOSE; f_close_standing_punch_timer = App->frames; }
			}break;

			case IN_F_KIK: {
				if (!close) { state = F_KIK_STANDING; f_standing_kik_timer = App->frames; }
				else if (close) { state = F_KIK_CLOSE; f_close_standing_kik_timer = App->frames; }
			}break;

			case IN_L_YFIRE: state = L_YFIRE; hadoken_timer = App->frames; break;
			case IN_M_YFIRE: state = M_YFIRE; hadoken_timer = App->frames; break;
			case IN_F_YFIRE: state = F_YFIRE; hadoken_timer = App->frames; break;

			case IN_L_YFLAME: state = L_YFLAME; l_yflame_timer = App->frames; break;
			case IN_M_YFLAME: state = M_YFLAME; m_yflame_timer = App->frames; break;
			case IN_F_YFLAME: state = F_YFLAME; f_yflame_timer = App->frames; break;
			...
			case IN_M_GRABBED: state = M_GRABBED; m_grabbed_timer = App->frames; break;
		...
		case ST_WALK_FORWARD:
		{
			...
			case IN_IDLE: state = ST_IDLE; break;
			...
			case IN_M_PUNCH: {
				if (!close) { state = M_PUNCH_STANDING; m_standing_punch_timer = App->frames; }
				else if (close) { state = M_GRABBING; grabbing_timer = App->frames; }
			}break;
			...
			case IN_F_PUNCH: {
				if (!close) { state = F_PUNCH_STANDING; f_standing_punch_timer = App->frames; }
				else if (close) { state = F_GRABBING; grabbing_timer = App->frames; }
			}break;
			...
			case IN_DEFENDING: state = ST_DEFENDING; defending_timer = App->frames; break;
		...
		case ST_JUMP_NEUTRAL:
		{
			...
			case IN_M_PUNCH: state = M_PUNCH_NEUTRAL_JUMP; break;
		...
		case ST_JUMP_FORWARD:
		{
			...
			case IN_M_PUNCH: state = M_PUNCH_FORWARD_JUMP; m_d_jumping_punch_timer = App->frames; break;
		...
		case ST_JUMP_BACKWARD:
		{
			...
			case IN_M_PUNCH: state = M_PUNCH_BACKWARD_JUMP; m_d_jumping_punch_timer = App->frames; break;
		...
		case L_YFIRE:
		{
			switch (last_input)
			{
			case IN_YFIRE_FINISH: state = ST_IDLE; break;
		...
		case L_YFLAME:
		{
			switch (last_input)
			{
			case IN_YFLAME_FINISH: state = ST_IDLE; break;
		...
		case YDRILL:
		{
			switch (last_input)
			{
			case IN_YDRILL_FINISH: state = ST_IDLE; break;
			case IN_FALLING: state = ST_FALLING; break;
			case IN_BURNING: state = BURNING; break;
		...
		case YMUMMY:
		{
			switch (last_input)
			{
			case IN_YMUMMY_FINISH: state = ST_IDLE; break;
			case IN_FALLING: state = ST_FALLING; break;
			case IN_BURNING: state = BURNING; break;
		...
		case ST_CROUCHING:
		{
			...
			case IN_TURNING: state = CROUCH_TURNING; turning_timer = App->frames;  break;
		...
		case ST_CROUCH:
		{
			...
			case IN_L_PUNCH: {
				if (!close) { state = L_PUNCH_CROUCH; l_crouching_punch_timer = App->frames; }
				else if (close) { state = L_PUNCH_CROUCHCLOSE; l_close_crouching_punch_timer = App->frames; }
			}break;

			case IN_L_KIK: {
				if (!close) { state = L_KIK_CROUCH; l_crouching_kik_timer = App->frames; }
				else if (close) { state = L_KIK_CROUCHCLOSE; l_close_crouching_kik_timer = App->frames; }
			}break;

			case IN_M_PUNCH: {
				if (!close) { state = M_PUNCH_CROUCH; m_crouching_punch_timer = App->frames; }
				else if (close) { state = M_PUNCH_CROUCHCLOSE; m_close_crouching_punch_timer = App->frames; }
			}break;

			case IN_M_KIK: {
				if (!close) { state = M_KIK_CROUCH; m_crouching_kik_timer = App->frames; }
				else if (close) { state = M_KIK_CROUCHCLOSE; m_close_crouching_kik_timer = App->frames; }
			}break;

			case IN_F_PUNCH: state = F_PUNCH_CROUCH; f_crouching_punch_timer = App->frames; break;
			case IN_F_KIK: state = F_KIK_CROUCH; f_crouching_kik_timer = App->frames; break;
		...
		case ST_CROUCH_DEFENDING_READY:
		{
			...
			case IN_M_GRABBED: state = M_GRABBED; m_grabbed_timer = App->frames; break;
			case IN_F_GRABBED: state = F_GRABBED; f_grabbed_timer = App->frames; break;
			case IN_DEFENDING: state = ST_CROUCH_DEFENDING; crouch_defending_timer = App->frames; break;
		...
		case ST_HEAD_REEL:
		{
			...
			{
			case IN_REEL_FINISH: {
				if (dizzi) { state = ST_DIZZI; dizzi_timer = App->frames; }
				else state = ST_IDLE;
			} break;
		...
		case ST_DIZZI:
		{
			switch (last_input)
			{
			case IN_DIZZI_FINISH:state = ST_IDLE; break;
			case IN_M_GRABBED: state = M_GRABBED; m_grabbed_timer = App->frames; break;
			case IN_F_GRABBED: state = F_GRABBED; f_grabbed_timer = App->frames; break;
			case IN_HEAD_REEL: state = ST_HEAD_REEL; head_reel_timer = App->frames; break;
			case IN_GUT_REEL: state = ST_GUT_REEL; gut_reel_timer = App->frames; break;
		...
		case M_GRAB:
		{
			switch (last_input)
			{
			case IN_M_GRAB_FINISH:state = ST_IDLE; break;
			}
		}
		break;
		...
		case F_GRAB:
		{
			switch (last_input)
			{
			case IN_F_GRAB_FINISH:state = ST_IDLE; break;
			}
		}
		break;
		...
		case TURNING:
		{
			switch (last_input)
			{
			case IN_TURNING_FINISH:state = ST_IDLE; break;
		...
		case CROUCH_TURNING:
		{
			switch (last_input)
			{
			case IN_TURNING_FINISH:state = ST_CROUCH; break;
		...
		case SWEEP:
		{
			switch (last_input)
			{
			case IN_SWEEP_FINISH:state = ST_GETTING_UP; getting_up_timer = App->frames; break;
			case IN_LOOSE: state = LOOSE; break;
			}
		}
		break;
